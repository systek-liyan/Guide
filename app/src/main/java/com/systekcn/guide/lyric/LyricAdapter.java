...
public class LyricAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (mIndexOfCurrentSentence == position) {
            ...
            holder.lyric_line.setTextColor(mContext.getResources().getColor(R.color.myOrange));
            holder.lyric_line.setTextSize(mCurrentSize);
        } else {
            // 其他的句子设置为暗色，字体大小较小
            holder.lyric_line.setTextColor(mContext.getResources().getColor(R.color.myWhite));
