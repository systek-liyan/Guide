 ...
 *
 */
public class TempDownloadService extends IntentService implements IConstants {
     ...
     */
    public TempDownloadService() {
        super("TempDownloadService");
    }

    @Override
    protected void onHandleIntent(Intent intent) {

        String museumId=intent.getStringExtra(INTENT_MUSEUM_ID);
        if(TextUtils.isEmpty(museumId)){return;}
        boolean isDownload= (boolean) Tools.getValue(MyApplication.get(), museumId, false);
    ...
    private MuseumNetInfo connectWifi(String museumId){
